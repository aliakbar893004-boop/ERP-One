...
{
    /// <inheritdoc />
    public partial class AddMasterDataF0 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Warehouses",
                columns: new[] { "Id", "Address", "Code", "CreatedAt", "CreatedBy", "IsActive", "IsDefault", "ModifiedAt", "ModifiedBy", "Name" },
                values: new object[] { 1, null, "WH-MAIN", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "system", true, true, null, null, "Gudang Utama" });
