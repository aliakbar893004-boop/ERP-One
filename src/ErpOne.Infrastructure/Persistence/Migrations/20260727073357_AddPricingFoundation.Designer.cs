...
namespace ErpOne.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260727073357_AddPricingFoundation")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ErpOne.Domain.Entities.CostLayer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ProductVariantId", "WarehouseId", "Id");

                    b.ToTable("S_CostLayers");
                });
            ...
            modelBuilder.Entity("ErpOne.Domain.Entities.PriceList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("M_PriceLists");
                });

            modelBuilder.Entity("ErpOne.Domain.Entities.PriceListLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PriceListId", "ProductVariantId", "MinQty")
                        .IsUnique();

                    b.ToTable("M_PriceListLines");
                });

            modelBuilder.Entity("ErpOne.Domain.Entities.PricingSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("DefaultMaxDiscountPercent")
                        .HasPrecision(5, 2)
                        .HasColumnType("decimal(5,2)");
            ...
            modelBuilder.Entity("ErpOne.Domain.Entities.PurchaseReturn", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("InventoryTotal")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.ToTable("T_PurchaseReturns");
                });

            modelBuilder.Entity("ErpOne.Domain.Entities.PurchaseReturnLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("T_PurchaseReturnLines");
                });
            ...
            modelBuilder.Entity("ErpOne.Domain.Entities.SalesReturn", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("T_SalesReturns");
                });

            modelBuilder.Entity("ErpOne.Domain.Entities.SalesReturnLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ErpOne.Domain.Entities.Customer", b =>
                {
                    b.HasOne("ErpOne.Domain.Entities.PriceList", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ErpOne.Domain.Entities.PurchaseReturnLine", b =>
                {
                    ...
                    b.HasOne("ErpOne.Domain.Entities.PurchaseReturn", null)
                        .WithMany("Lines")
            ...
            modelBuilder.Entity("ErpOne.Domain.Entities.SalesReturnLine", b =>
                {
                    ...
                    b.HasOne("ErpOne.Domain.Entities.SalesReturn", null)
                        .WithMany("Lines")
